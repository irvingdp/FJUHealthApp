    ...
    render() {
        ...
        return (
            <TouchableOpacity style={{
                ...
                <View>
                    <Text
                        style={[Texts.Font_20_400, {color: Colors.textBlack,}]}>{this.props.report.reservation.package.title}</Text>
                    <Text style={[Texts.Font_14_400, {
                        color: Colors.textGrey,
                        marginTop: 8
                    }]}>{moment(this.props.report.reservation.reserveDate).format("YYYY-MM-DD")}</Text>
                </View>
